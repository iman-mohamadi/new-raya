...
const flipClockVariants = cva(
  "relative flex justify-center items-center font-mono font-medium opacity-0 transition-opacity duration-300",
  {
    variants: {
      size: {
...
onMounted(() => {
  mounted.value = true // Ensures hydration is safe and fades the clock in
...
<template>
  <div :class="cn(flipClockVariants({ size, variant }), mounted && 'opacity-100', props.class)">
